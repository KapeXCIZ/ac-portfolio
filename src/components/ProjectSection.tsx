...
export default function ProjectSection() {
    const runnerUp = ["case study", "case study"];
    const runnerDown = ["next.js", "tailwind", "vercel"];
    ...
    return (
        <span className="relative w-fit mx-auto flex flex-col justify-center items-center mt-30">
