...
export default function AboutTeaser() {
    ...
    return (
        <section className="container mx-auto my-50 sm:my-60 md:my-70 lg:my-80 flex justify-center items-center flex-col gap-8 relative">
            ...
            <AnimeText className="text-center overflow-hidden font-sans text-3xl md:text-4xl font-light z-1 px-6">{t("r1")}<br /><span className="italic font-serif">{t("r2")}</span></AnimeText>
