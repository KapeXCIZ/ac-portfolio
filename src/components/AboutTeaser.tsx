...
export default function AboutTeaser() {
    return (
        <section className="container mx-auto my-50 sm:my-60 md:my-70 lg:my-80 flex justify-center items-center flex-col gap-8 relative">
            ...
            <Image src={"/images/home/siluette.png"} height={200} width={200} alt="Alessio's siluette" className="w-[240px] mask-b-from-50% mask-b-to-90%  brightness-0 invert dark:invert-0 -top-28 select-none [image-select: none]  absolute " />
