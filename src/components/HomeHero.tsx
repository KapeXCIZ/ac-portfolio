                    ...
                    <div className="flex flex-col gap-8 py-8 text-center ">
                        <span className="spotlight-text z-1">
                            ...
                            >
                                ...
                                , I&#39;m <span
                                    className="underline decoration-accent-400 text-foreground hover:text-transparent transition-colors duration-200 decoration-[4px] underline-offset-8  [-webkit-text-stroke:1px_color-mix(in_srgb,var(--color-foreground)_100%,transparent)] relative group"
                                >
                                    <span className="relative">Alessio<StarFourIcon weight="fill" className="absolute text-foreground text-[10px] md:text-[12px] lg:text-[14px] group-hover:opacity-0 sm:bottom-[34%]  md:bottom-[34%] lg:bottom-[38px] transition-opacity duration-200 ease-in-out sm:left-[138px] md:left-[165px] lg:-translate-y-1/5  lg:left-[222px] hidden sm:block" />
                                        <StarFourIcon weight="light" className="absolute text-foreground text-[10px] md:text-[12px] lg:text-[14px] opacity-0 group-hover:opacity-100 sm:bottom-[34%]  md:bottom-[34%] lg:bottom-[38px] transition-opacity duration-200 ease-in-out sm:left-[138px] md:left-[165px] lg:-translate-y-1/5  lg:left-[222px] hidden sm:block" /></span> Capecchi</span>
                                <br />
                                <span className="font-serif text-accent-[--foreground]">Web<Typewrite phrases={[" Developer.", " Wizard.", " Designer.", " Magician."]} period={175} id={1} /></span>
                            </h1>
                            <h2 className="font-sans text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extralight">I build <span className="font-thin">clean</span>, <span className="italic  text-foreground">fast</span>, <span className="font-normal">user-focused</span> web applications</h2>
                        </span>
