...
export default function AboutHero() {
    ...
    return (
        <div className="relative h-[75vh] max-h-[800px]   overflow-y-hidden w-full flex flex-col justify-start items-center max-w-screen overflow-x-hidden">
            <div className="fixed flex flex-col justify-start items-center">
                ...
                <div className="relative isolate w-fit h-full flex justify-end items-end">
