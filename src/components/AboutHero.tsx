...
export default function AboutHero() {
    ...
    useMotionValueEvent(scrollY, "change", (latest) => {
        setImageBlur(transform(latest, [0, 800], [0, 10]))
    })
    ...
    return (<>
        <div className={cn("relative h-[75vh] max-h-[650px]  md:max-h-[800px] -z-40   overflow-y-hidden w-full flex flex-col justify-end items-center max-w-screen overflow-x-hidden transition duration-300 ease-in-out")} >
            <div className="fixed h-[75vh] max-h-[650px] top-20 md:max-h-[800px]  w-full flex flex-col justify-start  items-center -z-10" style={{ filter: `blur(${imageBlur}px)` }}>
                ...
                <div className={cn("relative isolate w-full h-full  opacity-100 transition-opacity duration-300 ")}>
