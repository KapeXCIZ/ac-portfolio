...
export default function AboutContent() {
    return (
        <div className="w-full   bg-background backdrop-blur-2xl z-1 border-t mask-none  lg:mask-x-from-92% lg:mask-x-to-100% px-10 md:px-16 lg:px-20 container py-10 pt-40 flex gap-8 flex-col mx-auto ">
