...
export default function AboutContent() {
    ...
    return (
        <div className="w-full border-t   bg-linear-to-b from-background-2 to-background   z-0    rounded-t-[4em] md:rounded-t-[6em] lg:rounded-t-[8em] xl:rounded-t-[10em] pt-10  flex items-center justify-center gap-8 flex-col mx-auto ">
            <div className="container max-w-[1000px] px-10 md:px-16 lg:px-20">
                ...
                <section className="flex gap-5 flex-col pb-16 mx-auto">
                    <h1 className=" text-5xl md:text-6xl text-left md:text-center  xl:text-7xl font-deco mb-3 md:mb-6">{t("h1")}</h1>
                    ...
                    <AnimeText className="font-sans font-light text-accent-foreground text-2xl lg:text-3xl inline-block relative py-10 md:text-center  my-2"><QuotesIcon weight="light" className="absolute top-0 left-0" />{t("text.bigP")}<QuotesIcon weight="light" className="absolute bottom-0 right-0" /></AnimeText>
