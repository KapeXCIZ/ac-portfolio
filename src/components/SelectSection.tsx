...
export default function SelectSection() {
    ...
    return (
        <section className="flex justify-center flex-col px-4 lg:flex-row items-center text-body h-[90vh] gap-6 container *:max-h-[1000px] mx-auto py-4 md:py-10 ">
            <a href="/about"
                ...
                //     handleClick(e);
                // }}
                className={cn("group min-w-0 text-left overflow-visible dev-selection card h-full w-full flex flex-col justify-start gap-4  text-white/95  flex-[1] transition-[flex] hover:flex-[1.5] rounded-2xl ease-spring duration-(--spring-duration)  relative photography-selection selection  *:z-10 box pointer-events-none", devAnimating ? "animating" : "", safari ? "shadow-xl shadow-accent-1000/15 dark:shadow-accent-300/5 " : "")}>
                ...
                <Image src={
                    "/images/work-in-progress-2.png"
                }
                    width={1000}
                    height={1000}
                    alt="work in progress sign"
                    className="absolute w-50 top-6 right-6  saturate-150"
                ></Image>
            ...
            <a href="https://photo.alessiocapecchi.com/" onMouseEnter={() => router.prefetch("https://photo.alessiocapecchi.com/")} onClick={(e) => {
                ...
                handleClick(e);
            }} className={cn("group min-w-0 text-left overflow-visible card h-full w-full flex flex-col justify-start gap-4  text-white/95  flex-[1] transition-[flex] hover:flex-[1.5] rounded-2xl ease-spring duration-(--spring-duration) relative photography-selection selection  *:z-10 ", photoAnimating ? "animating" : "", safari ? "shadow-xl shadow-accent-1000/15 dark:shadow-accent-300/10" : "")}>
                <span className="w-full h-full overflow-hidden p-6 md:p-10">
